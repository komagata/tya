...
- Parser: simple assignment, simple function headers, `push`, `return`, `if`,
  ...
  direct comparison conditions, call comparison conditions,
...
- C codegen: string/int assignments, simple integer addition assignments,
  ...
  print nodes, carried indexing, call indexing, call-with-call-index arguments,
  call comparison conditions, and direct comparison conditions, and simple
  literal or variable `if` / `while` / `for` blocks with `break` / `continue`
