...
layout: doc
title: Spec
permalink: /v0.66/spec/
---

# Tya Language Specification

Status: released. v0.66 freezes the current v1 release-gate policy,
standard-library blocker set, diagnostics reference, package, tooling,
