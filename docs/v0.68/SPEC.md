...
layout: doc
title: Spec
permalink: /v0.68/spec/
---

# Tya Language Specification

Status: released. v0.68 changes class and interface member declarations to canonical colon syntax and preserves ordinary assignment syntax.
...
`TYA_PATH`, `TYA_LIB_DIR`, `TYA_RUNTIME_DIR`, `TYA_PROJECT_ROOT`, `TYA_ZIG`,
