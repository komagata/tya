...
- active: make stage-3 codegen emit executable checker C from real checker-driver nodes.

## Next Action

Make stage-3 codegen emit executable checker C from real checker-driver nodes,
