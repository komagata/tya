...
show_help() {
  ...
  echo "  --agent AGENT, -a AGENT     Select agent: $(supported_agents_list) (default: ${RALPH_AGENT:-codex})"
  ...
  echo "  ✅ Runs the verification commands requested by .agent/PROMPT.md"
  echo ""
  echo -e "${B}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${R}"
  ...
  echo -e "         ${G}./ralph.sh${R}              # Start the Codex loop"
  echo -e "         ${G}./ralph.sh -a claude${R}    # Or choose another supported agent"
  echo ""
  ...
  echo "  3. Run project verification, normally go test ./... -count=1"
