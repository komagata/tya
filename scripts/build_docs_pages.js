...
const pages = [
  ...
  { source: path.join(docsDir, "v0.60", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.60", "release_notes.html"), title: "Release Notes v0.60", versioned: true },
  { source: path.join(docsDir, "v0.59", "SPEC.md"), output: path.join(docsDir, "v0.59", "spec.html"), title: "Spec v0.59", versioned: true },
  { source: path.join(docsDir, "v0.59", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.59", "release_notes.html"), title: "Release Notes v0.59", versioned: true },
  { source: path.join(docsDir, "v0.58", "SPEC.md"), output: path.join(docsDir, "v0.58", "spec.html"), title: "Spec v0.58", versioned: true },
  { source: path.join(docsDir, "v0.58", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.58", "release_notes.html"), title: "Release Notes v0.58", versioned: true },
  { source: path.join(docsDir, "v0.57", "SPEC.md"), output: path.join(docsDir, "v0.57", "spec.html"), title: "Spec v0.57", versioned: true },
  { source: path.join(docsDir, "v0.57", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.57", "release_notes.html"), title: "Release Notes v0.57", versioned: true },
  { source: path.join(docsDir, "v0.56", "SPEC.md"), output: path.join(docsDir, "v0.56", "spec.html"), title: "Spec v0.56", versioned: true },
  { source: path.join(docsDir, "v0.56", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.56", "release_notes.html"), title: "Release Notes v0.56", versioned: true },
  { source: path.join(docsDir, "v0.55", "SPEC.md"), output: path.join(docsDir, "v0.55", "spec.html"), title: "Spec v0.55", versioned: true },
  { source: path.join(docsDir, "v0.55", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.55", "release_notes.html"), title: "Release Notes v0.55", versioned: true },
  { source: path.join(docsDir, "v0.54", "SPEC.md"), output: path.join(docsDir, "v0.54", "spec.html"), title: "Spec v0.54", versioned: true },
  { source: path.join(docsDir, "v0.54", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.54", "release_notes.html"), title: "Release Notes v0.54", versioned: true },
  { source: path.join(docsDir, "v0.53", "SPEC.md"), output: path.join(docsDir, "v0.53", "spec.html"), title: "Spec v0.53", versioned: true },
  { source: path.join(docsDir, "v0.53", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.53", "release_notes.html"), title: "Release Notes v0.53", versioned: true },
  { source: path.join(docsDir, "v0.52", "SPEC.md"), output: path.join(docsDir, "v0.52", "spec.html"), title: "Spec v0.52", versioned: true },
  { source: path.join(docsDir, "v0.52", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.52", "release_notes.html"), title: "Release Notes v0.52", versioned: true },
  { source: path.join(docsDir, "v0.51", "SPEC.md"), output: path.join(docsDir, "v0.51", "spec.html"), title: "Spec v0.51", versioned: true },
  { source: path.join(docsDir, "v0.51", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.51", "release_notes.html"), title: "Release Notes v0.51", versioned: true },
  { source: path.join(docsDir, "v0.50", "SPEC.md"), output: path.join(docsDir, "v0.50", "spec.html"), title: "Spec v0.50", versioned: true },
  { source: path.join(docsDir, "v0.50", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.50", "release_notes.html"), title: "Release Notes v0.50", versioned: true },
  { source: path.join(docsDir, "v0.49", "SPEC.md"), output: path.join(docsDir, "v0.49", "spec.html"), title: "Spec v0.49", versioned: true },
  { source: path.join(docsDir, "v0.49", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.49", "release_notes.html"), title: "Release Notes v0.49", versioned: true },
  { source: path.join(docsDir, "v0.48", "SPEC.md"), output: path.join(docsDir, "v0.48", "spec.html"), title: "Spec v0.48", versioned: true },
  { source: path.join(docsDir, "v0.48", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.48", "release_notes.html"), title: "Release Notes v0.48", versioned: true },
  { source: path.join(docsDir, "v0.47", "SPEC.md"), output: path.join(docsDir, "v0.47", "spec.html"), title: "Spec v0.47", versioned: true },
  { source: path.join(docsDir, "v0.47", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.47", "release_notes.html"), title: "Release Notes v0.47", versioned: true },
  { source: path.join(docsDir, "v0.46", "SPEC.md"), output: path.join(docsDir, "v0.46", "spec.html"), title: "Spec v0.46", versioned: true },
  { source: path.join(docsDir, "v0.46", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.46", "release_notes.html"), title: "Release Notes v0.46", versioned: true },
  { source: path.join(docsDir, "v0.45", "SPEC.md"), output: path.join(docsDir, "v0.45", "spec.html"), title: "Spec v0.45", versioned: true },
  { source: path.join(docsDir, "v0.45", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.45", "release_notes.html"), title: "Release Notes v0.45", versioned: true },
  { source: path.join(docsDir, "v0.44", "SPEC.md"), output: path.join(docsDir, "v0.44", "spec.html"), title: "Spec v0.44", versioned: true },
  { source: path.join(docsDir, "v0.44", "MIGRATION.md"), output: path.join(docsDir, "v0.44", "migration.html"), title: "Migration v0.44", versioned: true },
  { source: path.join(docsDir, "v0.44", "RELEASE_NOTES.md"), output: path.join(docsDir, "v0.44", "release_notes.html"), title: "Release Notes v0.44", versioned: true },
  { source: path.join(docsDir, "v0.43", "SPEC.md"), output: path.join(docsDir, "v0.43", "spec.html"), title: "Spec v0.43", versioned: true },
  { source: path.join(docsDir, "v0.42", "SPEC.md"), output: path.join(docsDir, "v0.42", "spec.html"), title: "Spec v0.42", versioned: true },
  ...
  { source: path.join(docsDir, "v0.39", "SPEC.md"), output: path.join(docsDir, "v0.39", "spec.html"), title: "Spec v0.39", versioned: true },
  { source: path.join(docsDir, "v0.38", "SPEC.md"), output: path.join(docsDir, "v0.38", "spec.html"), title: "Spec v0.38", versioned: true },
  { source: path.join(docsDir, "v0.37", "SPEC.md"), output: path.join(docsDir, "v0.37", "spec.html"), title: "Spec v0.37", versioned: true },
  { source: path.join(docsDir, "v0.36", "SPEC.md"), output: path.join(docsDir, "v0.36", "spec.html"), title: "Spec v0.36", versioned: true },
  { source: path.join(docsDir, "v0.35", "SPEC.md"), output: path.join(docsDir, "v0.35", "spec.html"), title: "Spec v0.35", versioned: true },
  { source: path.join(docsDir, "v0.34", "SPEC.md"), output: path.join(docsDir, "v0.34", "spec.html"), title: "Spec v0.34", versioned: true },
  { source: path.join(docsDir, "v0.33", "SPEC.md"), output: path.join(docsDir, "v0.33", "spec.html"), title: "Spec v0.33", versioned: true },
  { source: path.join(docsDir, "v0.32", "SPEC.md"), output: path.join(docsDir, "v0.32", "spec.html"), title: "Spec v0.32", versioned: true },
  { source: path.join(docsDir, "v0.31", "SPEC.md"), output: path.join(docsDir, "v0.31", "spec.html"), title: "Spec v0.31", versioned: true },
  { source: path.join(docsDir, "v0.30", "SPEC.md"), output: path.join(docsDir, "v0.30", "spec.html"), title: "Spec v0.30", versioned: true },
  { source: path.join(docsDir, "v0.29", "SPEC.md"), output: path.join(docsDir, "v0.29", "spec.html"), title: "Spec v0.29", versioned: true },
  { source: path.join(docsDir, "v0.29", "CODES.md"), output: path.join(docsDir, "v0.29", "codes.html"), title: "Codes v0.29", versioned: true },
  { source: path.join(docsDir, "v0.28", "SPEC.md"), output: path.join(docsDir, "v0.28", "spec.html"), title: "Spec v0.28", versioned: true },
  { source: path.join(docsDir, "v0.27", "SPEC.md"), output: path.join(docsDir, "v0.27", "spec.html"), title: "Spec v0.27", versioned: true },
  { source: path.join(docsDir, "v0.26", "SPEC.md"), output: path.join(docsDir, "v0.26", "spec.html"), title: "Spec v0.26", versioned: true },
