...
for src in examples/arithmetic.tya examples/function.tya examples/while.tya examples/if.tya examples/array.tya examples/string.tya examples/object.tya examples/object_inline.tya examples/object_builtin.tya examples/convert.tya examples/file.tya; do
