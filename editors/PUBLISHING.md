...
- `komagata.tya` version `0.72.1` publish accepted by GitHub Actions run
  `26579427382`; public gallery queries may lag behind Marketplace publish
...
- Generated package: `editors/vscode/tya-0.72.1.vsix`
...
- `komagata.tya` version `0.72.1` publish accepted by GitHub Actions run
  `26579434869`; public metadata queries may lag behind Open VSX publish
  acceptance for several minutes.
